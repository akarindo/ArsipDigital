            ...
            <div className="card-body-master">
              ...
              <div className="fm-menu mt-3">
                <div className="list-group list-group-flush"> 
                  ...
                  <div onClick={() => navigate("/dataMaster/KodeArsipMaster")} className={`list-group-item active py-2 ${tab === "KodeArsipMaster" ? "" : ""}`}><span>Kode Arsip</span></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="customers-list mb-3" style={{width: '78%'}}>
          <div className="customers-list-item d-flex align-items-center justify-content-between p-3 cursor-pointer bg-white radius-10" style={{marginBottom: 15}}>
            <div className="kiri" style={{display: 'flex', alignItems: 'center'}}>
              ...
              <div className="ms-3">
                <h6 className="mb-1 font-14">OJK-001</h6>
              </div>
            </div>
          ...
          <div className="customers-list-item d-flex align-items-center justify-content-between p-3 cursor-pointer bg-white radius-10" style={{marginBottom: 15}}>
            <div className="kiri" style={{display: 'flex', alignItems: 'center'}}>
              ...
              <div className="ms-3">
                <h6 className="mb-1 font-14">TAB-002</h6>
              </div>
            </div>
            <div className="kanan" style={{display: 'flex'}}>
              <div className="d-flex align-items-center pb-0 pt-0 gap-3">
          ...
          <div className="customers-list-item d-flex align-items-center justify-content-between p-3 cursor-pointer bg-white radius-10" style={{marginBottom: 15}}>
            <div className="kiri" style={{display: 'flex', alignItems: 'center'}}>
              ...
              <div className="ms-3">
                <h6 className="mb-1 font-14">PJ-015</h6>
              </div>
            </div>
            <div className="kanan" style={{display: 'flex'}}>
              <div className="d-flex align-items-center pb-0 pt-0 gap-3">
            ...
            <div className="modal-body">
              ...
              <form>
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control radius-30" placeholder="Masukkan Kode Arsip" />
                </div>
              </form>
            </div>
