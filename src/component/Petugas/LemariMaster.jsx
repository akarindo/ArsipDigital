            ...
            <div className="card-body-master">
              ...
              <div className="fm-menu mt-3">
                <div className="list-group list-group-flush"> 
                  ...
                  <div onClick={() => navigate("/dataMaster/LemariMaster")} className={`list-group-item active py-2 ${tab === "LemariMaster" ? "" : ""}`}><span>Lemari</span></div>
            ...
            <div className="modal-body">
              ...
              <form>
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control radius-30" placeholder="Masukkan Lemari" />
                </div>
              </form>
            </div>
